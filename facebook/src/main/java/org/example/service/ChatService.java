...
public class ChatService {
    ...
    public void writeMessagetoPersonalChatForFriend(File personalChat, String message) throws IOException {
        message = "                                               " + message;
    ...
    public void writeMessagePersonalChatForCurrentUser(File personalChat, String message) throws IOException {
        FileWriter fileWriter = new FileWriter(personalChat, true);
        fileWriter.write(message);
        String line = System.getProperty("line.separator");
        fileWriter.write(line);
